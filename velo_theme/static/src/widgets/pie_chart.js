odoo.define('velo_theme.PieChart2', function (require) {
"use strict";
...
var PieChart2 = Widget.extend({
    className: 'o_pie_chart',
    xmlDependencies: ['/velo_theme/static/src/xml/chart.xml'],
    ...
    init: function (parent, record, node) {
        ...
        var arch = qweb.render('velo_theme.PieChart2', {
            modifiers: modifiers,
...
widgetRegistry.add('pie_chart2', PieChart2);
